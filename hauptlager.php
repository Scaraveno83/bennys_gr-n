...
<main class="page-shell">
  <header class="page-header">
    <h1 class="page-title">🏭 Hauptlager</h1>
    <p class="page-subtitle">Ein- und Auslagerungen auf einen Blick – für alle berechtigten Mitarbeitenden und Administratoren.</p>
  </header>
  ...
  <section class="section-stack">
    ...
    <?php if ($isAdmin): ?>
      <article class="surface-panel">
        <header class="toolbar">
          <h2 class="headline-glow">🕒 Verlauf aller Aktionen</h2>
