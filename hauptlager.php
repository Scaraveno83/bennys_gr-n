...
.badge.minus { background:rgba(255,0,0,0.2); color:#ff6b6b; border:1px solid #ff6b6b; }
...
<main>
  <h2>🏭 Hauptlager</h2>
  <p>Hier werden alle Ein- und Auslagerungen protokolliert. Mitarbeiter mit Berechtigung und Admins können Rohstoffe oder Produkte hinzufügen und entnehmen.</p>
  ...
  <!-- 🕒 Verlauf (nur für Admins sichtbar) -->
  <?php if ($isAdmin): ?>
  <div class="card">
    <h3>🕒 Verlauf aller Aktionen</h3>
    <table>
      <thead>
      ...
      <tbody>
        <?php foreach ($verlauf as $v): ?>
          <tr>
            ...
            <td>
              <span class="badge <?= $v['aktion']==='hinzugefügt'?'plus':'minus' ?>">
                <?= htmlspecialchars($v['aktion']) ?>
              </span>
            </td>
