...
<main class="inventory-page admin-inventory-page">
  <header class="inventory-header">
    <h1 class="inventory-title">🧾 Hauptlager verwalten</h1>
    <p class="inventory-description">
      Pflege alle Warenein- und -ausgänge des Hauptlagers. Änderungen wirken sich sofort auf die öffentlichen Lagerseiten aus.
    </p>
    ...
    <div class="inventory-metrics">
      <article class="inventory-metric">
        ...
        <span class="inventory-metric__hint">Hauptlager gesamt</span>
      </article>
      ...
      <article class="inventory-metric">
        ...
        <span class="inventory-metric__hint">Einheiten aktuell verbucht</span>
      </article>

      <article class="inventory-metric <?= $kritischeProdukte ? 'inventory-metric--alert' : '' ?>">
        <span class="inventory-metric__label">Niedrige Bestände</span>
  ...
  <section class="inventory-section">
    ...
    <p class="inventory-section__intro">
      Erfasse Lieferungen oder Entnahmen. Die Übersicht aktualisiert sich unmittelbar nach der Buchung.
    </p>
